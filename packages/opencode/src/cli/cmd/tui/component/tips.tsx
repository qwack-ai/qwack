...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at qwack.ai",
  ...
  "Qwack auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Qwack auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Qwack uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Qwack from reading sensitive files",
  "Use {highlight}qwack run{/highlight} for non-interactive scripting",
  "Use {highlight}qwack --continue{/highlight} to resume the last session",
  "Use {highlight}qwack run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}qwack serve{/highlight} for headless API access to Qwack",
  "Use {highlight}opencode run --attach{/highlight} to connect to a running server",
  "Run {highlight}qwack upgrade{/highlight} to update to the latest version",
  "Run {highlight}qwack auth list{/highlight} to see all configured providers",
  "Run {highlight}qwack agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}qwack github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}qwack debug config{/highlight} to troubleshoot configuration",
